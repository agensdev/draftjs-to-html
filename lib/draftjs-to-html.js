(function (global, factory) {
  ...
  */
  ...
  function getEntityMarkup(entityMap, entityKey, text, customEntityTransform, blockText, isTipsBox, block) {
	...
	if (isTipsBox) {
	 return "<div style=\"margin-top:24px;margin-bottom:24px;background-color: #FAF0C9;border-radius:16px;border:1px solid #EBA35D;padding:16px;display:flex\">\n" +
	  ...
	  "</svg>\n" +
	  "</div>\n" +
	  "<p>" + getBlockInnerMarkup({...block, text: blockText}, entityMap, {}, customEntityTransform) + "</p></div>"
	}
  ...
  function getSectionMarkup(block, entityMap, section, customEntityTransform) {
    ...
    if (section.type === 'ENTITY') {
      if (section.entityKey !== undefined && section.entityKey !== null) {
        sectionText = getEntityMarkup(entityMap, section.entityKey, sectionText, customEntityTransform, "", false); // eslint-disable-line max-len
      }
  ...
  */
  ...
  function getBlockMarkup(block, entityMap, hashtagConfig, directional, customEntityTransform) {
    ...
    if (isAtomicEntityBlock(block)) {
      blockHtml.push(getEntityMarkup(entityMap, block.entityRanges[0].key, undefined, customEntityTransform, block.text, true, block));
    } else {
